# Generated by Django 3.2.12 on 2022-03-18 17:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='custom_fields', to='product.product')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
